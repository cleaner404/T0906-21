package com.example.cleaner208.t0906_21;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String strWord="3";//简单起见，这里指定ID，用户可在程序中设置id的实际值
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String strWord="Banana";
                String strMeaning="banana";
                String strSample="This banana is very bad.";
                ContentValues values = new ContentValues();
                ...
                int result = resolver.update(uri, values, Words.Word.COLUMN_NAME_WORD+"='Banana'", null);
        ...
        buttonQuery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Cursor cursor = resolver.query(Words.Word.CONTENT_URI,
                        new String[] {Words.Word.COLUMN_NAME_WORD, Words.Word.COLUMN_NAME_MEANING,Words.Word.COLUMN_NAME_SAMPLE},
                        Words.Word.COLUMN_NAME_WORD+"='Banana'", null, null);
                if (cursor == null){
                    Toast.makeText(MainActivity.this,"没有找到记录",Toast.LENGTH_LONG).show();
                    return;
                }
